...
no_of_cv = N/4       # e.g. gives us cross validation datasets of around 4-5 

# where to save?
savedir = home+'/WORK/LessTrainingData/{}'.format(N)
...
def run_one(data,name,output):
    ...
    d.pickle_object(savedir+'%s_%s_data'%(save_filename,name))
    #output.put((name))
